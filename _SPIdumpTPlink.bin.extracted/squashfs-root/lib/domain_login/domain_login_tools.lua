...
local function lua_mast_ntoa(mask)
    --[[
        Use 4294967295 to present 0xffffffff here
        DO NOT use 0xffffffff directly, cause in Lua5.1.4(double int32) Lua treat 0xffffffff as -1   
    ]]
    local number = 4294967295
    local m = bit.lshift(number, 32 - tonumber(mask))   -- left shift, it's different from << in C
    m = bit.band(4294967295, m)                         -- remove left bits, we only need 32bits
