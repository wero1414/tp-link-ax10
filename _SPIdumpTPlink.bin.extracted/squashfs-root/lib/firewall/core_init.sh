...
fw_load_defaults() {
	...
	fw add i f input
	fw add i f input_expolicy
	fw add i f output
	fw add i f forward

	fw add i f INPUT   input
	fw add i f INPUT   input_expolicy
	...
	fw add 6 f input_expolicy ACCEPT { "-p udp -m udp --dport 546" }
	fw add 6 f input_expolicy ACCEPT { "-p udp -m udp --dport 547" }
	fw add 6 f input_expolicy ACCEPT { "-p ipv6-icmp" }
	fw add 4 f input_expolicy ACCEPT { "-p udp -m udp --dport 68" }
